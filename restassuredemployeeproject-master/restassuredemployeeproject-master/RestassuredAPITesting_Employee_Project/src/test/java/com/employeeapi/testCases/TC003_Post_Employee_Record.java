...
//		requestParams.put("name", "Rohith"); // Cast
...
public class TC003_Post_Employee_Record extends TestBase {
    ...
    void createEmployee() throws InterruptedException {
        ...
        // Correctly handling the ID as an Integer and then converting it to a String
        Integer id = response.jsonPath().getInt("data.id");
        empId = id.toString();

        logger.info("Employee ID received from Response: " + empId);
    }
